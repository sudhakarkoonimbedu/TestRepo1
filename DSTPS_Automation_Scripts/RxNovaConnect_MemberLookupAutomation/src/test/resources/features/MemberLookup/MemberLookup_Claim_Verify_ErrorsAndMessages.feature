Feature: MemberLookup search verify Errors & Messages
  ...
  Scenario Outline: Verify Errors and Messages
    ...
    Examples: 
      ...
      | NCPDP^ | Reject Field^ | Argus^020 | Action^Information | Argus Error Text^INGRED COST > NDC AMT BY MORE THAN PLAN EXPECTS | Qualifier^1 | Continue^ | Message^PLAN MAX EXCEEDED |  
