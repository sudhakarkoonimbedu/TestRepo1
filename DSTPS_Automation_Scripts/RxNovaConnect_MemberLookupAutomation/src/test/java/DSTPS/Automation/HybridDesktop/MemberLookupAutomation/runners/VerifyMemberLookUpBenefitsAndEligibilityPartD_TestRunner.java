...
@CucumberOptions(
		features = {"classpath:features/MemberLookup/MemberLookup_BenefitsEligibility_Verify_PartD.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:memberlookup_benefitseligibility_verify_partd.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyMemberLookUpBenefitsAndEligibilityPartD_TestRunner extends AbstractTestNGCucumberTests {
