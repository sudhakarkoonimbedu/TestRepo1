...
@CucumberOptions(
		features = {"classpath:features/MemberLookup/MemberLookup_Authorization_Verify_CallNotes.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:memberlookup_authorization_verify_callnotes.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyMemberLookUpAuthorizationCallNotes_TestRunner extends AbstractTestNGCucumberTests {
