...
import DSTPS.Automation.HybridDesktop.MemberLookupAutomation.steps.MemberLookup_Pharmacy_CallNotes_Steps;
import cucumber.api.java.en.Then;

public class VerifyMemberLookUpPharmacyCallNotes {
	...
	public MemberLookup_Pharmacy_CallNotes_Steps memberLookup_Pharmacy_CallNotes_Steps;
	
	public VerifyMemberLookUpPharmacyCallNotes(HybridDesktop_SharedResource SharedResource, RxNova_Utlilty utils) throws Throwable{
	...
	public void init() throws Throwable
	{
		...
		memberLookup_Pharmacy_CallNotes_Steps = new MemberLookup_Pharmacy_CallNotes_Steps(SharedResource,utils);
	}	
	...
	public void user_click_on_call_notes() throws Throwable{
		...
		memberLookup_Pharmacy_CallNotes_Steps.clickOnCallNotes();
	}
	...
	public void add_call_notes(Map<String,String> addCallNotesDetails) throws Throwable{
		memberLookup_Pharmacy_CallNotes_Steps.provideCallNotesDetails(addCallNotesDetails);
		memberLookup_Pharmacy_CallNotes_Steps.addCallNotes();
	}
	...
	public void verify_previous_call_notes_comments(Map<String,String> previousCallNotesComments) throws Throwable{
		memberLookup_Pharmacy_CallNotes_Steps.verifyPreviousCallNotesComments(previousCallNotesComments);
	}
	...
	public void verify_call_notes_details(Map<String,String> callNotesDetails) throws Throwable{
		memberLookup_Pharmacy_CallNotes_Steps.verifyCallNotesDetails(callNotesDetails);
	}
}
