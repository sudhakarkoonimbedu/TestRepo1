...
@CucumberOptions(
		features = {"classpath:features/MemberLookup/MemberLookup_Formulary_Verify_GeneralInformation.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:memberlookup_formulary_verify_generalinformation.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyMemberLookUpFormularyGeneralInformation_TestRunner extends AbstractTestNGCucumberTests {
