...
@CucumberOptions(
		features = {"classpath:features/MemberLookup/MemberLookup_BenefitsEligibility_Verify_DualCoverage.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:memberlookup_benefitseligibility_verify_dualcoverage.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyMemberLookUpBenefitsAndEligibilityDualCoverage_TestRunner extends AbstractTestNGCucumberTests {
