...
@CucumberOptions(
		features = {"classpath:features/MemberLookup/MemberLookup_BenefitsEligibility_Verify_B&EDetail.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:memberlookup_benefitseligibility_verify_b&edetail.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyMemberLookUpBenefitsAndEligibilityDetail_TestRunner extends AbstractTestNGCucumberTests {
