...
@CucumberOptions(
		features = {"classpath:features/MemberLookup/MemberLookup_Formulary_Verify_CallNotes.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:memberlookup_formulary_verify_callnotes.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyMemberLookUpFormularyCallNotes_TestRunner extends AbstractTestNGCucumberTests {
