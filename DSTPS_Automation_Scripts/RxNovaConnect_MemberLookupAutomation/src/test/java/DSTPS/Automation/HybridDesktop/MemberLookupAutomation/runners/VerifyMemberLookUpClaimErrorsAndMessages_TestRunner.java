...
@CucumberOptions(
		features = {"classpath:features/MemberLookup/MemberLookup_Claim_Verify_ErrorsAndMessages.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:memberlookup_claim_verify_errorsandmessages.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyMemberLookUpClaimErrorsAndMessages_TestRunner extends AbstractTestNGCucumberTests {
