...
@CucumberOptions(
		features = {"classpath:features/MemberLookup/MemberLookup_Claim_Verify_CallNotes.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:memberlookup_claim_verify_callnotes.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyMemberLookUpClaimCallNotes_TestRunner extends AbstractTestNGCucumberTests {
