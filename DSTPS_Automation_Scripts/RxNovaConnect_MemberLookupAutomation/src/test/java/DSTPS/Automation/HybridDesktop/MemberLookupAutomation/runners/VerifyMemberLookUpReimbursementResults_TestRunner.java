...
@CucumberOptions(
		features = {"classpath:features/MemberLookup/MemberLookup_Reimbursement_Verify_ReimbursementResults.feature" },
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:memberlookup_reimbursement_verify_reimbursementresults.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyMemberLookUpReimbursementResults_TestRunner extends AbstractTestNGCucumberTests {
