...
@CucumberOptions(
		features = {"classpath:features/MemberLookup/MemberLookup_Reimbursement_Verify_CallNotes.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:memberlookup_reimbursement_verify_callnotes.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyMemberLookUpReimbursementCallNotes_TestRunner extends AbstractTestNGCucumberTests {
