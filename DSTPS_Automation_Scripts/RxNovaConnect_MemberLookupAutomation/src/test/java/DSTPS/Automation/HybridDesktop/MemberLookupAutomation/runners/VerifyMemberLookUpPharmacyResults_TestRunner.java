...
@CucumberOptions(
		features = {"classpath:features/MemberLookup/MemberLookup_Pharmacy_Verify_PharmacyResults.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:memberlookup_pharmacy_verify_pharmacyresults.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyMemberLookUpPharmacyResults_TestRunner extends AbstractTestNGCucumberTests {
