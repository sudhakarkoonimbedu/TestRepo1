...
@CucumberOptions(
		features = {"classpath:features/MemberLookup/MemberLookup_BenefitsEligibility_Verify_Deduductible&Accumulators.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:memberlookup_benefitseligibility_verify_deduductible&accumulators.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyMemberLookUpBenefitsAndEligibilityDeductibleAndAccumulator_TestRunner extends AbstractTestNGCucumberTests {
