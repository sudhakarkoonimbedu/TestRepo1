...
@CucumberOptions(
		features = {"classpath:features/MemberLookup/MemberLookup_Claim_Verify_AdditionalInformation.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:memberlookup_claim_verify_additionalinformation.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyMemberLookUpClaimAdditionalInformation_TestRunner extends AbstractTestNGCucumberTests {
