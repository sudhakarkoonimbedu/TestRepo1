...
@CucumberOptions(
		features = {"classpath:features/MemberLookup/MemberLookup_Claim_Verify_DrugInformation.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:memberlookup_claim_verify_druginformation.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyMemberLookUpClaimDrugInformation_TestRunner extends AbstractTestNGCucumberTests {
