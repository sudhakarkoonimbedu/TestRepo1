...
@CucumberOptions(
		features = {"classpath:features/MemberLookup/MemberLookup_Claim_Verify_ContextualHelp.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:memberlookup_claim_verify_contextualhelp.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyMemberLookUpClaimContextualHelp_TestRunner extends AbstractTestNGCucumberTests {
