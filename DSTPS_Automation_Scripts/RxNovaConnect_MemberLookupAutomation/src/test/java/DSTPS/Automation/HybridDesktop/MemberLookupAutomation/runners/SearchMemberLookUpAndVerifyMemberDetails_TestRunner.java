...
@CucumberOptions(
		features = {"classpath:features/MemberLookup/MemberLookup_Search_VerifyMemberDetails.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:memberlookup_search_verifymemberdetails.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class SearchMemberLookUpAndVerifyMemberDetails_TestRunner extends AbstractTestNGCucumberTests {
